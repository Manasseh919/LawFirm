    ...
    >
      ...
      <div className='container mx-auto h-full lg:flex pt-32'>
        <div className='text-center mx-auto h-full lg:text-left px-8 md:p-0'>
          <h1 className='font-primary font-black text-4xl lg:text-7xl text-primary mb-4 lg:mt-[70px] leading-tight lg:leading-[90px]'>
          Accessible,  <br /> <span className='text-accent'>Understandable</span>  <br /><span className='text-accent'>Affordable.</span>
          </h1>
